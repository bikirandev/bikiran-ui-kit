...
const InvoiceComp: FC<{
  ...
  const ownershipEditable: boolean = checkEditable("ChangeOwnership");
          ...
          <thead>
            <tr className="[&>th]:border [&>th]:bg-primary-100 [&>th]:border-black [&>th]:px-2 [&>th]:h-[50px] [&>th]:text-primary [&>th]:font-medium h-[50px]">
              ...
              <th className="w-[100px]">
                Price ({data?.invoice?.localCurrency})
              </th>
              <th className="w-[80px]">Quantity</th>
              <th className="w-[80px]">
                Total ({data?.invoice?.localCurrency})
              </th>
            </tr>
          </thead>
          <InvoiceTableBody
