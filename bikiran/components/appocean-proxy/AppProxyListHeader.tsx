...
const AppsProxyListHeader: FC = () => {
  const { reload, loading, proxyData } = useAppsProxyList();
  ...
  return (
    <TableHeaderWrapperComp
      ...
      modalType="create-apps-proxy"
      loading={loading}
      reload={reload}
      title="Apps Proxy List"
    >
...
export default AppsProxyListHeader;
