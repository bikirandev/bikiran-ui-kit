...
const AppsDatabaseListHeader: FC = () => {
  const { reload, loading } = useAppsDatabaseList();
  ...
  return (
    <TableHeaderWrapperComp
      ...
      modalType="create-apps-database"
      loading={loading}
      reload={reload}
      title="Apps Database List"
    >
...
export default AppsDatabaseListHeader;
