...
const AppsDomainListHeader: FC = () => {
  const { reload, loading, appsDomainData } = useAppsDomainList();
  ...
  return (
    <TableHeaderWrapperComp
      ...
      modalType="create-apps-domain"
      loading={loading}
      reload={reload}
      title="Apps Domain List"
    >
...
export default AppsDomainListHeader;
