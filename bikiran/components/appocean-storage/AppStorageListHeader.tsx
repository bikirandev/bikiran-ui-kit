...
const AppsStorageListHeader: FC = () => {
  const { reload, loading, storageList } = useAppsStorageList();
  ...
  return (
    <TableHeaderWrapperComp
      ...
      modalType="create-apps-Storage"
      loading={loading}
      reload={reload}
      title="Apps Storage List"
    >
...
export default AppsStorageListHeader;
