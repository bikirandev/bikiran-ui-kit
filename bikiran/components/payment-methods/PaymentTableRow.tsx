...
import { TPaymentData, TPaymentMethod } from "./PaymentMethodTypes";
...
import { ApiUpdatePaymentStatus } from "./PaymentMethodOperation";
type Props = {
  item: any;
  setIsDragging: any;
  isDragging: boolean;
...
const PaymentTableRow: FC<Props> = ({ item, setIsDragging, isDragging }) => {
  ...
  const { setConfirm, setMessage, setTemplateLoading, closeModal, openModal } =
    useTemplate();
