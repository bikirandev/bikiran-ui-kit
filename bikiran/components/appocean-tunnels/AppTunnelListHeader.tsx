...
const AppsTunnelListHeader: FC = () => {
  const { reload, loading, appsTunnelData } = useAppsTunnelList();
  ...
  return (
    <TableHeaderWrapperComp
      ...
      modalType="create-apps-tunnel"
      loading={loading}
      reload={reload}
      title="Apps Tunnel List"
    >
...
export default AppsTunnelListHeader;
