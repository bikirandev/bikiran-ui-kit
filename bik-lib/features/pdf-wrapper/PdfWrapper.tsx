...
const PdfWrapper: FC<Props> = ({
  ...
  return (
    <div
      className={`w-[800px] h-full mx-auto flex items-center justify-center print:items-start my-[50px] px-0 print:w-full print:h-screen print:my-0 print:px-[60px]  ${className}`}
    >
